...
@implementation YClearanceThreeCell
...
-(void)initView{
    ...
    _detailLb = [[UILabel alloc]initWithFrame:CGRectMake(9, CGRectYH(_titleLb)+3,  __kWidth*150/750, 13)];
