...
#import "YAddCardViewController.h"
#import "YBankCardDetailCell.h"
#import "YBankCheckCell.h"
#import "YBankCardChooseView.h"

@interface YAddCardViewController ()<UITableViewDelegate,UITableViewDataSource,YBankCardDetailCellDelegate,YBankCardChooseViewDelegate>
...
@implementation YAddCardViewController
...
#pragma mark ==确定添加==
-(void)sureAction{
    NSLog(@"%@的%@银行卡%@添加成功",_userName,_cardName,_cardNum);
