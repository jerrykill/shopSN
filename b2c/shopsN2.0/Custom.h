...
#define orderPayId       @"orderPayId"           //支付id
...
//苹果开发者中心创建APP获得的APPid
#define iphoneAppID @"1217720987"


//请求相关
#define RootURL @"http://api.shopsn.net/Home/"

#define TestURL @"http://test.shopsn.net/index.php/Home/"

//图片 根URL
#define HomeADUrl @"http://test.shopsn.net/"

//广告预览名
#define ADPlachorName @"adp"
//商品预览图名
#define goodPlachorName @"goodp"

//物流信息 url
#define OrderDeliveryUrl @"http://www.zzumall.com/kuaidi/index.php?num="

//分享根链接（根据网站的链接来的）
#define ShareGoodRoot @"http://test.shopsn.net/index.php/Home/Goods/goodsDetails/id/"



//支付宝
#define AlipayScheme @"shopsNAlixPay"
...
//客服账号
#define HXchatter @"jjj"

//通知类
#define CDidLoginNotification                        @"DidLoginNotification"                  //登录成功
#define CDidLogoutNotification                       @"DidLogoutNotification"                 //退出登录

#define YSTabBarChangeIndex @"tabSelectIndex"  //tabbar index变动
#define YSNotificationChange @"changeNoti"     //推送自定义改变

#define YSAddressChoose @"backToAddress" //地址选择
#define YSOrdersGoodChange @"changeOrderGood" //商品清单编辑
#define YSPayAndSendChange @"changePayAndSend" //配送和支付方式选择
#define YSCuponChoose   @"chooseCupon" //优惠券选择

#define YSGoodAddtoShopCart @"addCart" //添加到购物车

#define YSOrderStatusChange @"OrderData" //订单数据变动
#define YSOrderPayStatus @"PayStatus" //订单支付状态
